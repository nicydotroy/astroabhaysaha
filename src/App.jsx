...
function App() {
  ...
  useEffect(() => {
    ...
    const title = isKundaliPage ? 'Kundali Matching in Kolkata' : isBlackMagicPage ? 'Black Magic in Kolkata | Astro Avisek Sastri' : `Best Astrologer in ${location} | Avisek Sastri`
