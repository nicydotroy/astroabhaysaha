    ...
    <div className="site-shell">
      ...
      <footer className="site-footer">
        ...
        <div className="footer-grid">
          ...
          <div className="footer-column"><span className="footer-heading">Explore</span><button onClick={() => goTo('/')}>Home</button><button onClick={() => goTo('/about')}>About Avisek</button><button onClick={() => goTo('/services')}>Services</button><button onClick={() => goTo('/stories')}>Stories</button></div>
