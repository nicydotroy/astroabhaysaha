...
const servicePath = (service) => service.slug === 'kundali-matching' ? '/kundali-matching-in-kolkata' : `/services/${service.slug}`
...
const testimonials = [
  ...
  { name: 'Arjun K.', role: 'Founder', quote: 'Avisek has a rare ability to make the stars feel practical. The career guidance changed the way I made my next decision.' },
...
function App() {
  ...
  useEffect(() => {
    ...
    const title = isKundaliPage ? 'Kundali Matching in Kolkata' : `Best Astrologer in ${location} | Avisek Sastri`
    ...
    <div className="site-shell">
      <header className="site-header">
        <div className="header-identity">
          <button className="wordmark" onClick={() => goTo('/')} aria-label="Avisek Sastri home"><span className="wordmark-mark"><i>✦</i></span><span>Avisek<br /><b>Sastri</b></span></button>
        </div>
      ...
      <main>
        ...
        {(path.startsWith('/services') || path === '/kundali-matching-in-kolkata') && <ServicesPage path={path} onBook={() => setBookingOpen(true)} />}
      ...
      <div className="floating-contact-actions" aria-label="Contact Avisek Sastri">
        <a className="floating-contact-button floating-call-button" href="tel:+919163653093" aria-label="Call Avisek Sastri"><FaPhone className="contact-icon" aria-hidden="true" /><span>Call</span></a>
        <a className="floating-contact-button floating-whatsapp-button" href="https://wa.me/919163653093" target="_blank" rel="noreferrer" aria-label="Message Avisek Sastri on WhatsApp"><FaWhatsapp className="contact-icon" aria-hidden="true" /><span>WhatsApp</span></a>
      </div>
